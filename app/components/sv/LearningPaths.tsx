    ...
    <section id="learning-paths" className="section-container bg-gradient-to-br from-primary-50 via-white to-educational-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          <Link href="/sv/multiplikationstabeller/1-10" className="link-card group">
          ...
          <Link href="/sv/multiplikationstabeller/11-20" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/21-30" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/31-40" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/41-50" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/51-60" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/61-70" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/71-80" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/81-90" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/sv/multiplikationstabeller/91-100" className="link-card group">
            <div className="flex flex-col h-full">
        ...
        <div className="mt-10 bg-white border-2 border-primary-200 rounded-lg p-6 text-center">
          <p className="text-slate-700 text-lg">
            ...
            känner dig säker på varje nivå. När du når 100 är du expert på multiplikationstabeller!
          </p>
        </div>
      </div>
    </section>
