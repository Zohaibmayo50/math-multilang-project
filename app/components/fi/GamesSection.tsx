    ...
    <section id="games" className="section-container bg-gradient-to-br from-indigo-50 to-purple-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Opi kertotauluja hauskojen ja interaktiivisten pelien avulla
        </p>
        ...
        {!activeGame && (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div onClick={() => { setActiveGame('speed'); startSpeedGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Nopea laskenta</h3>
              <p className="text-slate-600 mb-4">Testaa nopeuttasi</p>
            ...
            <div onClick={() => { setActiveGame('hero'); startHeroGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Haaste</h3>
              <p className="text-slate-600 mb-4">Harjoittele paineessa</p>
            ...
            <div onClick={() => { setActiveGame('memory'); startMemoryGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Muistipeli</h3>
              <p className="text-slate-600 mb-4">Sovita parit</p>
            ...
            <div onClick={() => { setActiveGame('space'); startSpaceGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Kilpailu</h3>
              <p className="text-slate-600 mb-4">Kilpaile ystävien kanssa</p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              ...
              {speedActive ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Peli Päättyi!</h4>
                  <p className="text-xl text-slate-600 mb-6">Kokonaispisteet: <span className="font-bold text-green-600">{speedScore}</span></p>
        ...
        {activeGame === 'hero' && heroLives > 0 && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-purple-600">🏆 Haaste</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-purple-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Taso</div>
                  <div className="text-3xl font-bold text-purple-600">{heroLevel}</div>
                </div>
                <div className="bg-red-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Elämät</div>
                  <div className="text-3xl font-bold text-red-600">{'❤️'.repeat(heroLives)}</div>
                </div>
                <div className="bg-blue-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Edistyminen</div>
        ...
        {activeGame === 'memory' && (
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-pink-600">🎮 Muistipeli</h3>
                <div className="flex items-center gap-4">
                  <div className="bg-pink-50 rounded-lg px-4 py-2">
                    <span className="text-sm text-slate-600">Parit: </span>
              ...
              {memoryMatches === 6 ? (
                <div className="text-center py-12">
                  <div className="text-6xl mb-4">🎉</div>
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Onnittelut!</h4>
                  <p className="text-xl text-slate-600 mb-6">Löysit kaikki parit!</p>
        ...
        {activeGame === 'space' && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-indigo-600">🚀 Kilpailu</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-indigo-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Yritykset:</div>
                  <div className="text-3xl font-bold text-indigo-600">{rocketHeight}</div>
                </div>
                <div className="bg-orange-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Sarja</div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-slate-700">
                Jokainen peli käyttää eri oppimistekniikkaa. Nopea laskenta 
                parantaa nopeuttasi, Haaste auttaa sinua hallitsemaan vaikeustasojen, 
                Muistipeli tukee visuaalista oppimista ja Kilpailu lisää motivaatiotasi.
              </p>
            </div>
          </div>
        </div>
