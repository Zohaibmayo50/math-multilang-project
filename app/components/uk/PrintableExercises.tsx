  ...
  const handlePrint = () => {
    ...
    if (printWindow) {
      const title = exerciseType === 'single' 
        ? `Вправи Таблиці ${selectedTable}`
        : exerciseType === 'mixed'
        ? 'Вправи se smíšenými Таблицяmi násobilky'
        : `Вправи násobilky ${rangeStart}-${rangeEnd}`
      ...
      printWindow.document.write(`
        ...
        <html>
          ...
          <Рахунок>
            <button onclick="window.print()" class="print-button no-print">🖨️ Друк</button>
            <h1>${title}</h1>
            <div class="info">
              <p>Дата: ${new Date().toLocaleDateString('cs-CZ')}</p>
              <p>Celkový Кількість Завдань: ${questionCount}</p>
            </div>
            <div class="questions">
              ${questions.map((q, i) => `
                <div class="question">
                  <div class="question-number">Завдання ${i + 1}</div>
    ...
    <section id="pdf-exercises" className="section-container bg-gradient-to-br from-purple-50 to-pink-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-slate-900 mb-4 text-center">
          📄 Робочі Аркуші Таблиці множення для Друку
        </h2>
        
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Створіть власні робочі аркуші násobilky pro své žáky nebo děti. 
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                    ...
                    />
                    <div>
                      <div className="font-medium text-slate-900">Jedna Таблиця</div>
                      <div className="text-sm text-slate-600">Jedna konkrétní Таблиця násobilky</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                    ...
                    />
                    <div>
                      <div className="font-medium text-slate-900">Діапазон</div>
                      <div className="text-sm text-slate-600">Таблиці v určitém Діапазонu</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                    ...
                    />
                    <div>
                      <div className="font-medium text-slate-900">Змішані</div>
                      <div className="text-sm text-slate-600">Випадково з усіх таблиць</div>
                    </div>
                  </label>
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">
                  Кількість Завдань: {questionCount}
                </label>
                <input
                  type="range"
                  min="10"
                  ...
                  className="w-full h-2 bg-blue-200 rounded-lg appearance-noНі cursor-pointer"
                />
              ...
              <div>
                <label className="flex items-center p-4 bg-amber-50 border-2 border-amber-200 rounded-lg cursor-pointer">
                  ...
                  />
                  <div>
                    <div className="font-medium text-slate-900">Включити Ключ Відповідей</div>
                    <div className="text-sm text-slate-600">Přidá odpovědi na Кінець stránky</div>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200">
              <h3 className="text-lg font-bold text-slate-900 mb-4 flex items-center gap-2">
                <span>👁️</span> Попередній перегляд
              </h3>
              ...
              <div className="bg-white rounded-lg p-4 mb-4 space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-slate-900">
                    {exerciseType === 'single' 
                      ? `Таблиця ${selectedTable}`
                      : exerciseType === 'range'
                      ? `Таблиці ${rangeStart}-${rangeEnd}`
                      : 'Змішані'}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Кількість Завдань:</span>
                  <span className="font-semibold text-slate-900">{questionCount}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Ключ Відповідей:</span>
                  <span className={`font-semibold ${includeAnswers ? 'text-green-600' : 'text-slate-400'}`}>
                    {includeAnswers ? 'Так ✓' : 'Ні ✗'}
                  </span>
                </div>
              </div>

              <div className="bg-white rounded-lg p-4 space-y-2">
                <div className="text-sm font-semibold text-slate-700 mb-2">Приклади Завдань:</div>
                {[...Array(3)].map((_, i) => {
              ...
              <div className="mt-4 p-3 bg-blue-100 rounded-lg border border-blue-300">
                <p className="text-sm text-blue-900">
                  💡 <strong>Tip:</strong> Můžete použít funkci Друкu браузера для збереження як PDF.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
            ...
            <h4 className="font-bold text-slate-900 mb-2">Налаштовуваний</h4>
            <p className="text-sm text-slate-600">
              Налаштуйте кількість завдань, Таблиці a Рівень obtížnosti за потреби.
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
            <div className="text-3xl mb-3">📱</div>
            <h4 className="font-bold text-slate-900 mb-2">Зручність для Мобільних</h4>
            <p className="text-sm text-slate-600">
              Snadno Друкněte зі смартфона, планшета або комп'ютера.
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
            <div className="text-3xl mb-3">💾</div>
            <h4 className="font-bold text-slate-900 mb-2">Зберегти та Поділитися</h4>
            <p className="text-sm text-slate-600">
              Збережіть як PDF a легко поділіться зі своїми учнями.
            </p>
          </div>
        </div>
      </div>
