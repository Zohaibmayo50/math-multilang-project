      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-700">
            Pratiquez la table de {number} avec des jeux animés amusants !
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 justify-center mb-8">
          ...
          >
            🎈 <span className="hidden sm:inline">Jeu de Ballons</span><span className="sm:hidden">Ballons</span>
          </button>
          <button
          ...
          >
            🏎️ <span className="hidden sm:inline">Jeu de Course</span><span className="sm:hidden">Course</span>
          </button>
          <button
        ...
        {activeGame === 'balloon' && (
          <div className="bg-gradient-to-b from-sky-100 to-sky-300 rounded-2xl p-4 sm:p-8 shadow-xl min-h-[400px] sm:min-h-[600px] relative overflow-hidden">
            <div className="absolute top-2 sm:top-4 left-2 sm:left-4 right-2 sm:right-4 flex justify-between items-center z-10">
              ...
              <div className="bg-white/90 backdrop-blur-sm px-2 sm:px-4 py-1 sm:py-2 rounded-lg font-bold text-sm sm:text-lg">
                Manqués : <span className={bpMissed >= 3 ? 'text-red-600' : 'text-orange-600'}>{bpMissed}/5</span>
              </div>
            </div>
            ...
            {!bpGameActive ? (
              <div className="flex flex-col items-center justify-center h-[350px] sm:h-[500px]">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 px-4">Jeu de Ballons</h3>
                <p className="text-sm sm:text-base text-slate-700 mb-4 sm:mb-6 text-center max-w-md px-4">
                  Éclatez les ballons avec la bonne réponse ! Ne touchez pas les mauvais ballons et ne manquez pas les bons !
                </p>
                <button
                ...
                {bpScore > 0 && (
                  <div className="mt-4 sm:mt-6 text-base sm:text-lg">
                    Dernier score : <span className="font-bold text-pink-600">{bpScore}</span>
                  </div>
                )}
              </div>
            ) : (
        ...
        {activeGame === 'race' && (
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-600">Gagnez la course en répondant correctement !</p>
            </div>
            ...
            {!raceGameActive || raceCar.position >= 90 ? (
              <div className="text-center py-8 sm:py-12">
                ...
                {raceCar.position >= 90 ? (
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 px-4">Êtes-vous prêt pour la course ?</h3>
                )}
                <button
                ...
                >
                  {raceCar.position >= 90 ? 'Rejouer' : 'Démarrer la course'} 🏎️
                </button>
              </div>
            ) : (
              <div>
        ...
        {activeGame === 'memory' && (
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-600">Trouvez les cartes correspondantes !</p>
            </div>

            {cards.length === 0 ? (
              <div className="text-center py-8 sm:py-12">
                <div className="text-6xl sm:text-8xl mb-4 sm:mb-6">🃏</div>
                <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 px-4">Associez les cartes</h3>
                <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 px-4">Associez les multiplications aux résultats !</p>
                <button
              ...
              <div>
                <div className="flex justify-center gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="text-base sm:text-lg font-semibold">
                    Associés : <span className="text-green-600">{memoryScore}/6</span>
                  </div>
                  <div className="text-base sm:text-lg font-semibold">
                    Coups : <span className="text-purple-600">{memoryMoves}</span>
                  </div>
                </div>
