...
export default function NumberPage({ number, rangeStart, rangeEnd }: NumberPageProps) {
  ...
  const getNumberMeaning = () => {
    const meanings: { [key: number]: string} = {
      ...
      3: "Multiplicar por 3 significa tomar un número tres fois. Puedes pensarlo como sumar el mismo número a sí mismo tres fois. Esta tabla es esencial para entender triángulos, tríos y todo lo que viene en groupes de tres.",
      4: "Multiplicar por 4 es como duplicar dos fois. Como 4 = 2 × 2, puedes duplicar un número y luego duplicar el rÃ©sultat otra vez. Esto hace que aprender la tabla del 4 sea más fácil si ya conoces la del 2. El número 4 aparece frecuentemente en geometría (los cuadrados tienen 4 lados) y en la medición del tiempo (hay 4 cuartos en una hora).",
      ...
      8: "Multiplicar por 8 es como duplicar tres fois (8 = 2 × 2 × 2). Duplica un número, duplica el rÃ©sultat otra vez, y duplícalo una vez más—habrás multiplicado por 8. Esta tabla es más fácil de aprender si conoces bien las tablas del 2 y 4. El 8 es un número importante en geometría (octógonos) y música (octava).",
      9: "Multiplicar por 9 tiene uno de los modÃ¨les más fascinantes en matemáticas. Cuando sumas los dígitos de todos los múltiplos del 9, el rÃ©sultat siempre es divisible por 9. Además, el dígito de las decenas de 9 × n siempre es n-1. Esta tabla también se puede aprender con el truco de los dedos. Como 9 es solo 1 menos que 10, también se puede calcular usando la tabla del 10.",
      ...
      11: "Multiplicar por 11 tiene uno de los modÃ¨les más interesantes en matemáticas. Cuando multiplicas números de un dígito por 11, el rÃ©sultat es ese número repetido dos fois (11×3=33, 11×7=77). Al multiplicar números de dos dígitos por 11, también hay un patrón hermoso: sumas los dígitos y los colocas en el medio. El 11 es un número primo y tiene propriÃ©tÃ©s matemáticas especiales.",
      ...
      13: "Multiplicar por 13 desarrolla las habilidades de reconocimiento de modÃ¨les de los estudiantes. El 13 es un número primo, por lo que no se puede derivar simplemente de otras tablas. Sin embargo, pensar en 13 como 10+3 es muy útil: multiplicar un número por 13 significa multiplicarlo por 10 y sumar el rÃ©sultat de multiplicarlo por 3. El 13 es un número con significado especial en muchas culturas.",
      14: "Multiplicar por 14 es el doble de la tabla del 7. Como 14 = 2 × 7, si conoces la tabla del 7, puedes duplicar cada rÃ©sultat para encontrar la tabla del 14. El 14 es importante en la planificación semanal (2 semanas = 14 días) y muestra propriÃ©tÃ©s de números pares.",
      15: "Multiplicar por 15 combina los múltiplos tanto del 3 como del 5. Como 15 = 3 × 5, esta tabla lleva las propriÃ©tÃ©s de ambos números. Todos los múltiplos del 15 son divisibles tanto por 3 como por 5. Como 15 minutos es un cuarto de hora, se usa mucho en cálculos de tiempo.",
      ...
      20: "Multiplicar por 20 es la extensión natural de la tabla del 10. Cuando multiplicas cualquier número por 20, puedes multiplicarlo por 10 y duplicar el rÃ©sultat. O simplemente agrega un cero al final y duplica. La tabla del 20 se usa constantemente en cálculos monetarios (20 pesos) y mediciones (20 metros, 20 kilogramos).",
      21: "Multiplicar por 21 requiere entender la relación 3×7. Como 21=3×7, esta tabla lleva las propriÃ©tÃ©s de las tablas del 3 y del 7. El 21 es importante como edad legal de mayoría en muchos países. Pensar en 21 como 20+1 facilita los cálculos: multiplica un número por 20 y agrégale el número mismo.",
      22: "Multiplicar por 22 es el doble del 11 (22=2×11). Si conoces la tabla del 11, puedes duplicar cada rÃ©sultat para encontrar la tabla del 22. Como 22 también es 2×11, muestra propriÃ©tÃ©s de números pares. El 22 aparece frecuentemente en deportes (equipo de fútbol) y conteo diario.",
      23: "Multiplicar por 23 no se puede derivar de otras tablas debido a sus propriÃ©tÃ©s de número primo. Sin embargo, pensar en 23 como 20+3 o 25-2 facilita los cálculos. El 23 es un número importante en biología (número de pares de cromosomas humanos). Aprender la tabla del 23 fortalece las habilidades de aritmética mental.",
      ...
      25: "Multiplicar por 25 usa la relación 5×5 (5²). Como 25 es el cuadrado de 5, tiene propriÃ©tÃ©s matemáticas muy especiales. Es importante en cálculos monetarios (25 centavos son un cuarto). Todos los múltiplos del 25 terminan en 25, 50, 75, 00 - un patrón muy regular.",
      26: "Multiplicar por 26 es el doble del 13 (26=2×13). Si conoces la tabla del 13, puedes duplicar cada rÃ©sultat para encontrar la tabla del 26. El 26 es el número de letras en el alfabeto inglés. Pensar en 26 como 25+1 o 30-4 facilita los cálculos.",
      ...
      28: "Multiplicar por 28 usa la relación 4×7. Como 28=4×7=2×14, se puede aprender de múltiples maneras. 28 días es el número de días en febrero (cuando no es año bisiesto). El 28 también es un número perfecto (la addition de sus divisores es igual a sí mismo: 1+2+4+7+14=28).",
      ...
      34: "Multiplicar por 34 es el doble del 17 (34=2×17). Si conoces la tabla del 17, puedes duplicar cada rÃ©sultat para encontrar la tabla del 34. La addition de los dígitos en 34 es 7 (3+4=7), lo que conduce a modÃ¨les relacionados con el 7. Pensar en 34 como 35-1 o 30+4 facilita los cálculos.",
      35: "Multiplicar por 35 usa la relación 5×7. Si ambas tablas son conocidas, multiplicar por 35 es bastante fácil. Todos los múltiplos del 35 terminan en 5 o 0 (como los múltiplos del 5). 35 minutos son 5 minutos más que media hora. La relación 35=5×7 combina las propriÃ©tÃ©s de ambas tablas del 5 y del 7.",
      ...
      37: "Multiplicar por 37 requiere estrategias especiales debido a que es número primo. Pensar en 37 como 40-3 o 35+2 facilita los cálculos. El 37 tiene relaciones interesantes con números repdigit: 37×3=111. Esta propriÃ©tÃ© especial del 37 se puede usar para algunos cálculos trucos.",
      38: "Multiplicar por 38 es el doble del 19 (38=2×19). Si conoces la tabla del 19, puedes duplicar cada rÃ©sultat para encontrar la tabla del 38. Pensar en 38 como 40-2 facilita el cálculo mental. 38 grados Celsius es fiebre leve para la temperatura corporal humana.",
      ...
      44: "Multiplicar por 44 es cuatro fois el 11 (44=4×11). Si conoces la tabla del 11, puedes cuadruplicarla, o multiplicar la tabla del 4 por 11 para calcularla. La relación 44=2×22 también ofrece un método diferente. El 44 muestra un patrón similar a repdigit y tiene propriÃ©tÃ©s de números pares.",
      ...
      46: "Multiplicar por 46 es el doble del 23 (46=2×23). Si conoces la tabla del 23, puedes duplicar cada rÃ©sultat para encontrar la tabla del 46. Pensar en 46 como 45+1 o 50-4 facilita los cálculos. El 46 es el número total de cromosomas humanos (23 pares).",
      47: "Multiplicar por 47 requiere estrategias mentales debido a sus propriÃ©tÃ©s de número primo. Los métodos más efectivos son pensar en 47 como 50-3 o 45+2. El 47 es un número primo y tiene propriÃ©tÃ©s matemáticas especiales. Aprender la tabla del 47 desarrolla la habilidad de trabajar cómodamente con números complejos.",
      48: "Multiplicar por 48 tiene muchas relaciones de factores. Como 48=6×8=4×12=3×16=2×24, se puede calcular de múltiples maneras. Como el 48 es 4 fois 12, es útil en cálculos de docenas (4 docenas). 48 horas = 2 días, se encuentra frecuentemente en cálculos de tiempo.",
      ...
      53: "Multiplicar por 53 desarrolla estrategias de matemática mental debido a sus propriÃ©tÃ©s de número primo. Los métodos más prácticos son pensar en 53 como 50+3 o 55-2. El 53 es un número primo y solo es divisible por 1 y 53. Aprender la tabla del 53 aumenta la capacidad de trabajar con números primos grandes y profundiza el pensamiento matemático.",
      54: "Multiplicar por 54 es una de las tablas más versátiles. Como 54=6×9=2×27=3×18, se puede calcular de muchas maneras diferentes. El 54 es 3 fois la addition de los números del 1 al 10 (1+2+...+10=55 aproximadamente). Como combina las tablas del 6 y del 9, refuerza ambas. Tener muchos divisores lo hace útil en cálculos de fracciones.",
      55: "Multiplicar por 55 usa la relación 5×11. Si ambas tablas son conocidas, multiplicar por 55 es fácil. La estrategia 55=50+5 también es muy práctica. El 55 es la addition de los números del 1 al 10 (1+2+3+...+10=55), esta relación matemática especial lo hace interesante. El patrón del 5 (termina en 5 o 0) facilita el cálculo.",
      ...
      58: "Multiplicar por 58 es el doble del 29 (58=2×29). Si conoces la tabla del 29, puedes duplicar cada rÃ©sultat para encontrar la tabla del 58. Pensar en 58 como 60-2 o 50+8 facilita el cálculo. Como es un número par, todos sus múltiplos también son pares. Esta tabla refuerza estrategias de duplicación y aproximación a números redondos.",
      59: "Multiplicar por 59 requiere estrategias especiales debido a sus propriÃ©tÃ©s de número primo y proximidad al 60. El método más efectivo es pensar en 59 como 60-1: multiplica un número por 60 y réstale el número mismo. El 59 es un número primo y solo es divisible por 1 y 59. La tabla del 59 proporciona contexto para cálculos de minutos y tiempo (59 minutos) debido a su proximidad al 60.",
      ...
      72: "Multiplicar por 72 es una de las tablas más versátiles. Como 72=8×9=6×12=4×18=3×24=2×36, se puede calcular de muchas maneras diferentes. El 72 es 3 fois el número de horas en un día (72 horas = 3 días). Tener muchos divisores lo hace extremadamente útil en cálculos de fracciones. El 72 es 6 fois 12 (6 docenas).",
      73: "Multiplicar por 73 desarrolla propriÃ©tÃ©s de número primo y estrategias de cálculo mental. Los métodos más prácticos son pensar en 73 como 70+3 o 75-2. El 73 es un número primo y solo es divisible por 1 y 73. El 73 también es el primo número 21 y tiene propriÃ©tÃ©s matemáticas interesantes.",
      74: "Multiplicar por 74 usa la relación 2×37. Si conoces la tabla del 37, puedes duplicar cada rÃ©sultat para encontrar la tabla del 74. Pensar en 74 como 70+4 o 75-1 facilita el cálculo. Como es un número par, todos sus múltiplos también son pares. El 74 es divisible tanto por 2 como por 37.",
      ...
      82: "Multiplicar por 82 usa la relación 2×41. Si conoces la tabla del 41, puedes duplicar cada rÃ©sultat para encontrar la tabla del 82. Pensar en 82 como 80+2 o 85-3 facilita el cálculo. Como es un número par, todos sus múltiplos también son pares. El 82 es divisible tanto por 2 como por 41.",
      ...
      84: "Multiplicar por 84 es una de las tablas más versátiles. Como 84=7×12=6×14=4×21=3×28=2×42, se puede calcular de muchas maneras diferentes. El 84 es 12 fois el número de horas en una semana, o 7 fois un medio día de 12 horas. Tener muchos divisores lo hace útil en cálculos de fracciones.",
      ...
      86: "Multiplicar por 86 usa la relación 2×43. Si conoces la tabla del 43, puedes duplicar cada rÃ©sultat para encontrar la tabla del 86. Pensar en 86 como 90-4 o 85+1 facilita el cálculo. Como es un número par, todos sus múltiplos también son pares. El 86 es divisible tanto por 2 como por 43.",
      ...
      94: "Multiplicar por 94 usa la relación 2×47. Si conoces la tabla del 47, puedes duplicar cada rÃ©sultat para encontrar la tabla del 94. Pensar en 94 como 100-6 o 90+4 facilita el cálculo. Como es un número par, todos sus múltiplos también son pares. El 94 es divisible tanto por 2 como por 47.",
      ...
      97: "Multiplicar por 97 requiere estrategias especiales debido a sus propriÃ©tÃ©s de número primo. La estrategia más fácil es pensar en 97 como 100-3: multiplica un número por 100 y réstale 3 fois el número. El 97 es un número primo y solo es divisible por 1 y 97. Ser el número primo más cercano a 100 facilita mucho el cálculo mental.",
      98: "Multiplicar por 98 usa la relación 2×49. Si conoces la tabla del 49, puedes duplicar cada rÃ©sultat para encontrar la tabla del 98. La relación 98=2×7² es interesante. Pensar en 98 como 100-2 es la estrategia más fácil. Como es un número par, todos sus múltiplos también son pares.",
    ...
    return meanings[number] || `Multiplicar por ${number} significa sumar el número ${number} repetidamente. Cada vez que multiplicas, estás contando groupes de ${number}.`
  }

  const getWhyImportant = () => {
    const importance: { [key: number]: string } = {
      1: "La tabla del 1 es la base de todas las operaciones de multiplicación. Enseña a los estudiantes que los números tienen una identidad: al multiplicarse por 1, permanecen como ellos mismos. Este concepto es crucial para comprender propriÃ©tÃ©s algebraicas posteriores. Aunque parezca simple, aprender esta tabla genera confianza y establece el patrón de que la multiplicación es ordenada y predecible.",
      ...
      9: "La tabla del 9 tiene uno de los modÃ¨les matemáticos más fascinantes. La regla de addition de dígitos y el truco de los dedos muestran a los estudiantes el lado mágico de las matemáticas. Aprender la tabla del 9 no es solo memorización, enseña reconocimiento de modÃ¨les y comprensión de relaciones matemáticas. Esta tabla es perfecta para desarrollar habilidades de cálculo mental y construir confianza matemática.",
      ...
      14: "La tabla del 14 ayuda a reforzar la tabla del 7. La relación 14=2×7 muestra a los estudiantes la propriÃ©tÃ© distributiva de la multiplicación. Es necesaria para calcular periodos semanales y quincenales. Esta tabla profundiza la comprensión de las propriÃ©tÃ©s de números pares y estrategias de duplicación.",
      ...
      22: "La tabla del 22 ayuda a reforzar la tabla del 11. La relación 22=2×11 fortalece las estrategias de duplicación. Se usa en deportes (equipo de fútbol) y conteo diario. Esta tabla desarrolla la comprensión de propriÃ©tÃ©s de números pares y relaciones matemáticas.",
      ...
      28: "La tabla del 28 es importante para conocimiento de calendario (mes de febrero). Que el 28 sea un número perfecto (addition de divisores igual a sí mismo) muestra propriÃ©tÃ©s matemáticas especiales. La relación 28=4×7 profundiza la comprensión de factorización. Esta tabla se usa en cálculos de tiempo y planificación semanal.",
      ...
      33: "Multiplicar por 33 fortalece las relaciones matemáticas combinando las tablas del 3 y 11. La propriÃ©tÃ© repdigit (33, 66, 99...) facilita el reconocimiento de modÃ¨les. La relación 33=3×11 profundiza la comprensión de las conexiones entre factores y múltiplos. Esta tabla enseña estrategias de multiplicación múltiple.",
      34: "Multiplicar por 34 ayuda a reforzar la tabla del 17. La relación 34=2×17 muestra la conexión entre números primos y pares. Esta tabla desarrolla flexibilidad mental y métodos de cálculo alternativos (35-1, 30+4). Refuerza propriÃ©tÃ©s de números pares y habilidades de duplicación.",
      ...
      43: "La tabla del 43 desarrolla propriÃ©tÃ©s de números primos y estrategias de cálculo mental. Enfoques alternativos como 40+3 o 45-2 proporcionan flexibilidad en el pensamiento matemático. Esta tabla aumenta la habilidad de trabajar creativamente con números y enriquece las estrategias de resolución de problemas.",
      44: "La tabla del 44 es perfecta pour renforcer la tabla del 11. La relación 44=4×11 desarrolla habilidades de multiplicación múltiple. El patrón similar a repdigit (44, 88) facilita el reconocimiento visual. Profundiza la comprensión de propriÃ©tÃ©s de números pares y ser múltiplo de cuatro.",
      ...
      46: "La tabla del 46 ayuda a reforzar la tabla del 23. La relación 46=2×23 combina estrategias de duplicación y números primos. Es un número importante en biología (46 cromosomas). Esta tabla desarrolla propriÃ©tÃ©s de números pares y cálculos con números grandes.",
      47: "La tabla del 47 maximiza las estrategias de números primos. El enfoque 50-3 perfecciona la estrategia de restar de números redondos. Debido a propriÃ©tÃ©s primas, requiere flexibilidad mental y métodos de solución alternativos. Esta tabla proporciona habilidades avanzadas de matemática mental.",
      ...
      49: "La tabla del 49 es crítica para entender números cuadrados (7²). Requiere conocer perfectamente la tabla del 7 y la refuerza. La estrategia 50-1 enseña cálculo rápido usando números redondos. Es importante en geometría y cálculos de área debido a propriÃ©tÃ©s cuadradas.",
      ...
      55: "La tabla del 55 refuerza las relaciones matemáticas combinando las tablas del 5 y 11. La propriÃ©tÃ© de número triangular (1+2+...+10=55) profundiza la comprensión de modÃ¨les matemáticos. La relación 5×11 fortalece ambas tablas. Esta tabla forma una base para modÃ¨les numéricos y fórmulas de addition.",
      ...
      58: "La tabla del 58 ayuda a reforzar la tabla del 29. La relación 58=2×29 combina estrategias de duplicación y números primos. El enfoque 60-2 enseña la estrategia de aproximarse a números redondos. Esta tabla forma una base para propriÃ©tÃ©s de números pares y cálculos cercanos a 60.",
      59: "La tabla del 59 maximiza las estrategias de números primos. El enfoque 60-1 perfecciona el cálculo rápido usando números redondos. Debido a propriÃ©tÃ©s primas, requiere flexibilidad mental y métodos creativos de solución. Tiene importancia práctica en contexto de tiempo (59 minutos, 59 segundos). Esta tabla proporciona habilidades avanzadas de matemática mental.",
      ...
      61: "La tabla del 61 lleva las estrategias de números primos a un nivel avanzado. El enfoque 60+1 proporciona asociación con unidades de tiempo (minuto 61, segundo 61). Debido a sus propriÃ©tÃ©s primas, requiere flexibilidad mental y resolución creativa de problemas. Esta tabla desarrolla la habilidad de calcular rápidamente con números mayores a 60.",
      62: "La tabla del 62 ayuda a reforzar la tabla del 31. La relación 62=2×31 combina estrategias de duplicación y números primos. El enfoque 60+2 enseña la estrategia de calcular cerca de números redondos. Esta tabla forma una base para propriÃ©tÃ©s de números pares y cálculos después de 60.",
      ...
      68: "La tabla del 68 fortalece las conexiones matemáticas combinando las tablas del 4 y 17. Las relaciones 4×17=2×34 enseñan a usar múltiples estrategias. El enfoque 70-2 desarrolla la habilidad de aproximarse a números redondos. Esta tabla forma una base para propriÃ©tÃ©s de números pares y cálculos cercanos a 70.",
      ...
      73: "La tabla del 73 lleva las estrategias de números primos a un nivel avanzado. El enfoque 70+3 desarrolla habilidades de cálculo mental. Ser el primo número 21 despierta curiosidad matemática. Debido a propriÃ©tÃ©s primas, requiere métodos de solución alternativos y pensamiento creativo. Esta tabla proporciona habilidades de matemática mental avanzada.",
      74: "La tabla del 74 ayuda a reforzar la tabla del 37. La relación 74=2×37 combina estrategias de duplicación y números primos. El enfoque 75-1 enseña la estrategia de aproximarse a números redondos. Esta tabla forma una base para propriÃ©tÃ©s de números pares y cálculos cercanos a 75.",
      ...
      76: "La tabla del 76 fortalece las conexiones matemáticas combinando las tablas del 4 y 19. Las relaciones 4×19=2×38 enseñan estrategias de multiplicación múltiple. Los enfoques 75+1 o 80-4 proporcionan flexibilidad. Esta tabla prepara para cálculos cercanos a 80 con propriÃ©tÃ©s de números pares.",
      ...
      84: "Multiplicar por 84 es una de las tablas más versátiles. Como 84=12×7=6×14=4×21=3×28=2×42, se puede calcular de muchas maneras diferentes. El 84 es 7 fois 12 (7 docenas). Tener muchos divisores (1,2,3,4,6,7,12,14,21,28,42,84) lo hace extremadamente útil en cálculos de fracciones. El 84 es útil en cálculos de tiempo (84 horas=1 semana+1/2 día). Esta tabla perfecciona el uso de múltiples estrategias.",
      ...
      86: "Multiplicar por 86 usa la relación 2×43. Si conoces la tabla del 43, puedes duplicar cada rÃ©sultat para encontrar la tabla del 86. Pensar en 86 como 80+6 o 90-4 facilita el cálculo. Como es un número par, todos sus múltiplos también son pares. El 86 es divisible tanto por 2 como por 43. Esta tabla establece una base para cálculos cercanos a 90.",
      ...
      88: "Multiplicar por 88 usa las relaciones 8×11=4×22=2×44. Se puede calcular de múltiples maneras. El 88 muestra un patrón similar a repdigit (repetición de 8s). Pensar en 88 como 90-2 o 80+8 facilita el cálculo. Como es un número par, todos sus múltiplos también son pares. El 88 tiene muchos divisores. La propriÃ©tÃ© repdigit (88) facilita el reconocimiento visual y la memorización.",
      ...
      97: "Multiplicar por 97 desarrolla estrategias de matemática mental debido a sus propriÃ©tÃ©s de número primo. La estrategia más fácil es pensar en 97 como 100-3: multiplica un número por 100 y réstale tres fois el número mismo. El 97 es un número primo y solo es divisible por 1 y 97. Aprender la tabla del 97 facilita cálculos cercanos a 100. Ser el primo más cercano a 100 facilita extremadamente el cálculo mental. Ser primo es importante para teoría de números y criptografía.",
      98: "Multiplicar por 98 usa las relaciones 2×49=7×14. Se puede calcular de múltiples maneras. La estrategia más fácil es pensar en 98 como 100-2: multiplica un número por 100 y réstale dos fois el número mismo. Como es un número par, todos sus múltiplos también son pares. El 98 es divisible tanto por 2 como por 7 y 49. La relación 98=2×49=2×7² combina números cuadrados y estrategias de duplicación. Esta tabla proporciona dominio en cálculos cercanos a 100.",
      99: "Multiplicar por 99 usa la relación 9×11. La estrategia más fácil es pensar en 99 como 100-1: multiplica un número por 100 y réstale el número mismo. El 99 muestra un patrón similar a repdigit (repetición de 9s). Como 99=9×11, es divisible tanto por 9 como por 11. Esta tabla es extremadamente útil para cálculos cercanos a 100. La estrategia 100-1 es PERFECTA para matemática mental. La propriÃ©tÃ© repdigit (99) profundiza la comprensión de modÃ¨les. Esta tabla es extremadamente importante para habilidades de cálculo práctico.",
  ...
  const getPatterns = () => {
    const patterns: { [key: number]: { title: string; description: string }[] } = {
      1: [
        ...
        { title: "Base de Todas las Tables", description: "Cada tabla de multiplicar comienza con multiplicar por 1, por lo que este patrón aparece en todas las tablas." },
      ],
      2: [
        { title: "Solo Números Pares", description: "Todos los múltiplos de 2 son números pares. Los rÃ©sultats siempre terminan en 0, 2, 4, 6 u 8." },
      ...
      3: [
        { title: "Patrón de Suma de Dígitos", description: "Suma los dígitos de cada rÃ©sultat: 3 (3), 6 (6), 9 (9), 12 (1+2=3), 15 (1+5=6), 18 (1+8=9). ¡El patrón 3-6-9 se repite!" },
      ...
      4: [
        ...
        { title: "Doble de la Table de 2", description: "Cada respuesta es exactamente el doble de la respuesta correspondiente en la tabla del 2: 4×3=12 es el doble de 2×3=6." },
      ...
      5: [
        ...
        { title: "Mitad de la Table de 10", description: "Cada rÃ©sultat es exactamente la mitad de la tabla del 10: 5×4=20 es la mitad de 10×4=40." },
      ],
      6: [
        { title: "Siempre Números Pares", description: "Todos los múltiplos de 6 son pares. Los rÃ©sultats progresan como 6, 12, 18, 24, 30... y todos son divisibles por 2." },
        { title: "Doble de la Table de 3", description: "Cada respuesta es exactamente el doble de la tabla del 3: 6×4=24 es el doble de 3×4=12." },
      ...
      8: [
        ...
        { title: "Doble de la Table de 4", description: "Cada respuesta es exactamente el doble de la tabla del 4: 8×5=40 es el doble de 4×5=20." },
      ...
      11: [
        { title: "Patrón de Dígitos Dobles", description: "Cuando se multiplica por números de un dígito, el rÃ©sultat es dígitos dobles: 11×2=22, 11×3=33, 11×7=77, 11×9=99." },
        { title: "Truco de Suma de Dígitos", description: "Multiplica un número de dos dígitos por 11: addition los dígitos y colócalos en el medio. 23×11: 2_(2+3)_3 = 253." },
      ...
      12: [
        ...
        { title: "Múltiplos de Ambos 3 y 4", description: "Como 12=3×4, todos los rÃ©sultats son divisibles tanto por 3 como por 4. 12×5=60: 60÷3=20, 60÷4=15." },
      ...
      14: [
        { title: "Doble del 7", description: "Como 14=2×7, si conoces la tabla del 7 duplica cada rÃ©sultat: 7×6=42, entonces 14×6=84." },
      ...
      16: [
        ...
        { title: "Doble del 8", description: "Como 16=2×8, si conoces la tabla del 8 duplica cada rÃ©sultat: 8×3=24, entonces 16×3=48." },
      ...
      33: [
        ...
        { title: "Siempre Divisible por 3", description: "Todos los múltiplos de 33 son divisibles por 3 y 11. La addition de dígitos es múltiplo de 3." },
      ],
      34: [
      ...
      36: [
        ...
        { title: "Divisible por 9 y 4", description: "Todos los múltiplos de 36 son divisibles por 4 y 9. La addition de dígitos es múltiplo de 9." },
      ],
      37: [
      ...
      39: [
        ...
        { title: "Divisible por 3", description: "Todos los múltiplos de 39 son divisibles por 3 y 13. La addition de dígitos es múltiplo de 3." },
      ],
      40: [
      ...
      45: [
        ...
        { title: "Divisible por 9", description: "Todos los múltiplos de 45 son divisibles por 9. La addition de dígitos es múltiplo de 9: 135 (1+3+5=9)." },
      ],
      46: [
      ...
      54: [
        ...
        { title: "Divisible por 9", description: "Todos los múltiplos de 54 son divisibles por 9. La addition de dígitos es múltiplo de 9: 108 (1+0+8=9)." },
      ],
      55: [
      ...
      57: [
        ...
        { title: "Divisible por 3", description: "Todos los múltiplos de 57 son divisibles por 3 y 19. La addition de dígitos es múltiplo de 3." },
      ],
      58: [
      ...
      63: [
        ...
        { title: "Divisible por 7 y 9", description: "Todos los múltiplos de 63 son divisibles por 7 y 9. La addition de dígitos es múltiplo de 9." },
      ],
      64: [
      ...
      66: [
        ...
        { title: "Similar a Repdigit", description: "66×1=66, 66×2=132. Como 6 fois 11, sigue el patrón de la tabla del 11." },
      ...
      69: [
        ...
        { title: "Divisible por 3", description: "Todos los múltiplos de 69 son divisibles por 3 y 23. La addition de dígitos es múltiplo de 3." },
      ],
      70: [
      ...
      78: [
        ...
        { title: "Divisible por 2 y 3", description: "Todos los múltiplos de 78 son divisibles por 2 y 3. La addition de dígitos es múltiplo de 3." },
      ],
      79: [
      ...
      87: [
        ...
        { title: "Divisible por 3", description: "Todos los múltiplos de 87 son divisibles por 3 y 29. La addition de dígitos es múltiplo de 3." },
      ],
      88: [
      ...
      93: [
        ...
        { title: "Divisible por 3", description: "Todos los múltiplos de 93 son divisibles por 3. La addition de los dígitos es múltiplo de 3." },
      ],
      94: [
      ...
      97: [
        ...
        { title: "Patrones de Número Primo", description: "Como 97 es primo tiene modÃ¨les especiales. Dígito de las unidades: 7, 4, 1, 8, 5, 2, 9, 6, 3, 0." },
        { title: "Primo Más Cercano a 100", description: "El mayor número primo menor que 100. Esta propriÃ©tÃ© facilita mucho el cálculo." },
      ],
      98: [
  ...
  const getCommonMistakes = () => {
    const mistakes: { [key: number]: { mistake: string; solution: string }[] } = {
      1: [
        { mistake: "Pensar que 1×1=2", solution: "Recuerda: Todo lo que se multiplica por 1 es igual a sí mismo. 1 groupe de 1 es solo 1." },
        { mistake: "Confundir con la addition", solution: "Multiplicar por 1 es diferente de sumar. 5+1=6, pero 5×1=5." },
      ],
      2: [
        ...
        { mistake: "Confundirse con números grandes", solution: "Descompón: 2×8 es solo 8+8. Duplicar es addition simple." },
      ],
      3: [
      ...
      11: [
        ...
        { mistake: "Aplicar mal el truco de addition de dígitos", solution: "23×11: Suma los dígitos (2+3=5), colócalo en el medio: 253. Si la addition >9, hay acarreo: 67×11: 6_(6+7=13)_7 = 6_(13)_7 = 737." },
      ...
      59: [
        ...
        { mistake: "Confundir 59×9=521 con 59×9=531", solution: "59×9=531 es correcto (60×9=540, menos 9). 531 también es 9×59. 521 es otro rÃ©sultat." },
      ],
      60: [
      ...
      74: [
        ...
        { mistake: "Confundir 74×9=656 con 74×9=666", solution: "74×9=666 es correcto (37×9=333, ×2 o 75×9=675, menos 9). 666 es un número repdigit. 656 es otro rÃ©sultat." },
      ],
      75: [
      ...
      89: [
        ...
        { mistake: "Calcular 89 como 88+1", solution: "¡La estrategia 90-1 es mucho más fácil! 89×7: 90×7=630, luego soustraction 7: 623." },
      ],
      90: [
      ...
      97: [
        ...
        { mistake: "Calcular 97 como 96+1", solution: "¡La estrategia 100-3 es mucho más fácil! 97×7: 100×7=700, luego soustraction 21: 679." },
      ],
      98: [
      ...
      99: [
        ...
        { mistake: "Calcular 99 como 98+1", solution: "¡La estrategia 100-1 es mucho más fácil! 99×8: 100×8=800, luego soustraction 8: 792." },
      ],
      100: [
  ...
  const getPracticeStrategies = () => {
    const strategies: { [key: number]: string[] } = {
      ...
      9: [
        ...
        "Usa la regla de addition de dígitos: addition los dígitos de la respuesta, siempre da 9",
      ...
      16: [
        ...
        "Si conoces la tabla del 8, duplica cada rÃ©sultat: 8×7=56, entonces 16×7=112",
      ...
      22: [
        "Memoriza la tabla del 11, luego duplica cada rÃ©sultat",
      ...
      44: [
        "Cuatro fois 11: cuadruplica la tabla del 11",
      ...
      45: [
        ...
        "Temps: 45 minutos = tres cuartos de hora (3/4 de hora)",
      ],
      46: [
      ...
      70: [
        ...
        "Refuerza la tabla del 7: cada rÃ©sultat es 10 fois 7",
      ...
      80: [
        ...
        "Refuerza la tabla del 8: cada rÃ©sultat es 10 fois 8",
      ...
      90: [
        ...
        "Refuerza la tabla del 9: cada rÃ©sultat es 10 fois 9",
      ...
      100: [
        ...
        "Relación 10×10: 10 fois la tabla del 10",
