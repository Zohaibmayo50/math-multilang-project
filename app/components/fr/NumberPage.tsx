...
export default function NumberPageFr({ number, rangeStart, rangeEnd }: NumberPageProps) {
  return <UniversalNumberPage lang="fr" number={number} rangeStart={rangeStart} rangeEnd={rangeEnd} />
}
