...
export default function NumberPageId({ number, rangeStart, rangeEnd }: NumberPageProps) {
  return <UniversalNumberPage lang="id" number={number} rangeStart={rangeStart} rangeEnd={rangeEnd} />
}
