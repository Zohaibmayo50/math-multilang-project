...
interface PracticePreviewIdProps {
  rangeStart?: number
  rangeEnd?: number
}

export default function PracticePreviewId({ rangeStart = 1, rangeEnd = 10 }: PracticePreviewIdProps) {
    ...
    <section id="practice" className="section-container bg-gradient-to-br from-slate-50 to-blue-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Sangat penting untuk berlatih agar dapat menguasai tabel perkalian yang telah dipelajari. 
          Anda dapat berlatih dengan cara yang menyenangkan menggunakan alat-alat di bawah ini.
        </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-8">
                <div className="text-center">
                  <div className="text-sm text-slate-600 mb-1">Benar</div>
                ...
                <div className="text-center">
                  <div className="text-sm text-slate-600 mb-1">Akurasi</div>
                    ...
                    {feedback === 'correct' ? (
                      ...
                      <div>
                        ...
                        <div className="text-base text-slate-600">
                          Jawaban yang benar: {question.num1 * question.num2}
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <div onClick={() => startExercise('easy')} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border-2 border-gray-200 group">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-1">Tabel Perkalian 2-5</h3>
                  <p className="text-slate-600">20 Soal</p>
                </div>
            ...
            <div onClick={() => startExercise('medium')} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border-2 border-gray-200 group">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-1">Tabel Perkalian 6-8</h3>
                  <p className="text-slate-600">30 Soal</p>
                </div>
                <div className="text-3xl group-hover:scale-110 transition-transform">📋</div>
              </div>
              <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-blue-700 transition-all mt-4">
            ...
            <div onClick={() => startExercise('hard')} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border-2 border-gray-200 group">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-1">Tabel Perkalian 9-12</h3>
                  <p className="text-slate-600">40 Soal</p>
                </div>
                <div className="text-3xl group-hover:scale-110 transition-transform">📋</div>
              </div>
              <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-blue-700 transition-all mt-4">
            ...
            <div onClick={() => startExercise('expert')} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border-2 border-gray-200 group">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-1">Campuran Semua Tabel</h3>
                  <p className="text-slate-600">50 Soal</p>
                </div>
                <div className="text-3xl group-hover:scale-110 transition-transform">📋</div>
              </div>
              <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-blue-700 transition-all mt-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-blue-600">📝 Latihan</h3>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-slate-600">
                    Soal {currentQuestionIndex + 1} / {exerciseQuestions.length}
                  </span>
                  <span className="text-sm font-medium text-slate-600">
                    Benar: {exerciseQuestions.filter(q => q.correct === true).length}
                  </span>
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-12 mb-6">
                ...
                <div className="flex gap-4 items-center justify-center">
                  ...
                  >
                    {currentQuestionIndex < exerciseQuestions.length - 1 ? 'Selanjutnya' : 'Selesai'}
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="text-center py-8">
                ...
                <h3 className="text-3xl font-bold text-slate-900 mb-4">Latihan Selesai!</h3>
                ...
                <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto mb-8">
                  ...
                  <div className="bg-red-50 rounded-lg p-4">
                    <div className="text-sm text-slate-600 mb-1">Salah</div>
                ...
                {exerciseQuestions.filter(q => q.correct === false).length > 0 && (
                  <div className="mt-8 text-left max-w-xl mx-auto">
                    <h4 className="font-semibold text-slate-900 mb-4">Jawaban yang Salah:</h4>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="text-slate-700 space-y-1 text-sm">
                <li>• Mulai dengan soal yang mudah terlebih dahulu</li>
                <li>• Jangan terburu-buru, fokus pada akurasi</li>
                <li>• Lakukan latihan 10-15 menit setiap hari</li>
                <li>• Pelajari kesalahan yang Anda buat</li>
                <li>• Tingkatkan kesulitan secara bertahap</li>
              </ul>
            </div>
          </div>
        </div>
