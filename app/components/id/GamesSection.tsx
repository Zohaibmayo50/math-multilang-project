...
interface GamesSectionIdProps {
  rangeStart?: number
  rangeEnd?: number
}

export default function GamesSectionId({ rangeStart = 1, rangeEnd = 10 }: GamesSectionIdProps) {
    ...
    <section id="games" className="section-container bg-gradient-to-br from-indigo-50 to-purple-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Pelajari tabel perkalian dengan cara yang menyenangkan melalui permainan. Setiap permainan menawarkan metode pembelajaran yang berbeda.
        </p>
        ...
        {!activeGame && (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div onClick={() => { setActiveGame('speed'); startSpeedGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Jawaban Cepat</h3>
              <p className="text-slate-600 mb-4">Berapa soal yang bisa kamu selesaikan dalam 60 detik?</p>
            ...
            <div onClick={() => { setActiveGame('hero'); startHeroGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Pahlawan Perkalian</h3>
              <p className="text-slate-600 mb-4">Capai juara dengan melewati level</p>
            ...
            <div onClick={() => { setActiveGame('memory'); startMemoryGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Permainan Memori</h3>
              <p className="text-slate-600 mb-4">Kalikan dengan mencocokkan kartu</p>
            ...
            <div onClick={() => { setActiveGame('space'); startSpaceGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Petualangan Luar Angkasa</h3>
              <p className="text-slate-600 mb-4">Naikkan roketmu dengan jawaban benar</p>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-blue-600">🎯 Jawaban Cepat</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-blue-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Waktu</div>
                  <div className="text-3xl font-bold text-blue-600">{speedTimer}d</div>
                </div>
                <div className="bg-green-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Skor</div>
              ...
              {speedActive ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Permainan Selesai!</h4>
                  <p className="text-xl text-slate-600 mb-6">Total Skor: <span className="font-bold text-green-600">{speedScore}</span></p>
        ...
        {activeGame === 'hero' && heroLives > 0 && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-purple-600">🏆 Pahlawan Perkalian</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-red-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Nyawa</div>
                  <div className="text-3xl font-bold text-red-600">{'❤️'.repeat(heroLives)}</div>
                </div>
                <div className="bg-blue-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Progres</div>
        ...
        {activeGame === 'memory' && (
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-pink-600">🎮 Permainan Memori</h3>
                <div className="flex items-center gap-4">
                  <div className="bg-pink-50 rounded-lg px-4 py-2">
                    <span className="text-sm text-slate-600">Pasangan: </span>
              ...
              {memoryMatches === 6 ? (
                <div className="text-center py-12">
                  <div className="text-6xl mb-4">🎉</div>
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Selamat!</h4>
                  <p className="text-xl text-slate-600 mb-6">Kamu berhasil mencocokkan semua kartu!</p>
        ...
        {activeGame === 'space' && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-indigo-600">🚀 Petualangan Luar Angkasa</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-indigo-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Ketinggian</div>
                  <div className="text-3xl font-bold text-indigo-600">{rocketHeight}m</div>
                </div>
                <div className="bg-orange-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Beruntun</div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-slate-700">
                Setiap permainan menggunakan teknik pembelajaran yang berbeda. Jawaban Cepat meningkatkan 
                kecepatan Anda, Pahlawan Perkalian membantu Anda melewati tingkat kesulitan, Permainan 
                Memori mengembangkan pembelajaran visual, dan Petualangan Luar Angkasa meningkatkan motivasi Anda.
              </p>
            </div>
          </div>
        </div>
