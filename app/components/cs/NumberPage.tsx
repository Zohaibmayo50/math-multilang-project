...
export default function NumberPageCs({ number, rangeStart, rangeEnd }: NumberPageProps) {
  return <UniversalNumberPage lang="cs" number={number} rangeStart={rangeStart} rangeEnd={rangeEnd} />
}
