    ...
    <section id="games" className="section-container bg-gradient-to-br from-indigo-50 to-purple-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Učte se násobilku hravě pomocí interaktivních her. Každá hra nabízí jinou metodu učení.
        </p>
        ...
        {!activeGame && (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div onClick={() => { setActiveGame('speed'); startSpeedGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Rychlá Odpověď</h3>
              <p className="text-slate-600 mb-4">Kolik úkolů dokážete vyřešit za 60 sekund?</p>
            ...
            <div onClick={() => { setActiveGame('hero'); startHeroGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Hrdina Násobilky</h3>
              <p className="text-slate-600 mb-4">Postupujte úrovněmi a staňte se šampiónem</p>
            ...
            <div onClick={() => { setActiveGame('memory'); startMemoryGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Pexeso</h3>
              <p className="text-slate-600 mb-4">Najděte páry karet a násobte</p>
            ...
            <div onClick={() => { setActiveGame('space'); startSpaceGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Vesmírné Dobrodružství</h3>
              <p className="text-slate-600 mb-4">Nechte raketu stoupat správnými odpověďmi</p>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-blue-600">🎯 Rychlá Odpověď</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-blue-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Čas</div>
              ...
              {speedActive ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Hra Skončila!</h4>
                  <p className="text-xl text-slate-600 mb-6">Celkové body: <span className="font-bold text-green-600">{speedScore}</span></p>
        ...
        {activeGame === 'hero' && heroLives > 0 && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-purple-600">🏆 Hrdina Násobilky</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-purple-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Úroveň</div>
                  <div className="text-3xl font-bold text-purple-600">{heroLevel}</div>
                </div>
                <div className="bg-red-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Životy</div>
                  <div className="text-3xl font-bold text-red-600">{'❤️'.repeat(heroLives)}</div>
                </div>
                <div className="bg-blue-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Postup</div>
        ...
        {activeGame === 'memory' && (
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-pink-600">🎮 Pexeso</h3>
                <div className="flex items-center gap-4">
                  <div className="bg-pink-50 rounded-lg px-4 py-2">
                    <span className="text-sm text-slate-600">Páry: </span>
              ...
              {memoryMatches === 6 ? (
                <div className="text-center py-12">
                  <div className="text-6xl mb-4">🎉</div>
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Gratulujeme!</h4>
                  <p className="text-xl text-slate-600 mb-6">Našli jste všechny páry karet!</p>
        ...
        {activeGame === 'space' && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-indigo-600">🚀 Vesmírné Dobrodružství</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-indigo-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Výška</div>
                  <div className="text-3xl font-bold text-indigo-600">{rocketHeight}m</div>
                </div>
                <div className="bg-orange-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Série</div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-slate-700">
                Každá hra využívá jinou techniku učení. Rychlá Odpověď 
                zvyšuje vaši rychlost, Hrdina Násobilky vám pomáhá zvládnout úrovně obtížnosti, 
                Pexeso podporuje vizuální učení a Vesmírné Dobrodružství zvyšuje vaši motivaci.
              </p>
            </div>
          </div>
        </div>
