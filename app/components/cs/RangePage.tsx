...
export default function RangePage({ 
  ...
  const difficultyLabels = {
    beginner: 'Úroveň Začátečník',
    intermediate: 'Středně Pokročilá Úroveň',
  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          ...
          <div className="max-w-3xl mx-auto space-y-4 text-center">
            <p className="text-lg md:text-xl text-slate-700 leading-relaxed">
              Nauč se <span className="font-semibold text-blue-600">násobilku od {rangeStart} do {rangeEnd}</span> pomocí 
              <span className="font-semibold text-indigo-600"> zábavných her</span>, 
              <span className="font-semibold text-purple-600"> interaktivních cvičení</span> a 
              <span className="font-semibold text-pink-600"> tisknutelných pracovních listů</span>!
            </p>
      ...
      <section className="section-container bg-white py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base text-slate-700 mb-6 leading-relaxed text-center max-w-2xl mx-auto">
            Tento rozsah obsahuje násobilky všech čísel mezi {rangeStart} a {rangeEnd}. 
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border-2 border-blue-100 shadow-md">
            ...
            <div className="bg-white/60 rounded-xl p-4 flex items-center gap-3">
              ...
              <p className="text-sm text-slate-700 leading-relaxed">
                Žáci se v tomto rozsahu učí celkem <span className="font-bold text-indigo-600">{rangeNumbers.length * 10} násobení</span>. 
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-3xl font-bold text-slate-900">
              Násobilka od {rangeStart} do {rangeEnd} - Kompletní Seznam
            </h2>
            <button
              onClick={() => {
                ...
                if (printWindow) {
                  printWindow.document.write(`
                    ...
                    <html>
                    <head>
                      <title>Násobilka od ${rangeStart} do ${rangeEnd}</title>
                      <style>
                        @media print {
                          @page { margin: 1cm; }
                        }
                    ...
                    <body>
                      <h1>Násobilka od ${rangeStart} do ${rangeEnd} - Kompletní Seznam</h1>
                      <div class="grid">
      ...
      <section className="section-container bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            Jednotlivé Násobilky v Tomto Rozsahu
          </h2>
          
          <p className="text-lg text-slate-700 mb-8 leading-relaxed">
            Pokud se chcete naučit násobilku každého čísla podrobně, můžete přejít na příslušnou 
            stránku pomocí následujících odkazů. Každá stránka obsahuje vzory, 
            tipy a specifické nástroje pro cvičení pro toto číslo.
          </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-slate-600">
                      Podrobné vysvětlení a příklady pro číslo {num}
                    </p>
                  </div>
                  <svg 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className={`bg-white rounded-xl p-6 border-l-4 ${
              ...
              <p className="text-slate-700 leading-relaxed">
                {difficultyDescriptions[difficultyLevel]} {rangeStart === 1 ? 
                  ...
                  'Tento rozsah staví na znalostech z předchozího rozsahu.'}
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border-l-4 border-blue-500">
              ...
              <p className="text-slate-700 leading-relaxed">
                Tento rozsah pomáhá žákům rozvíjet schopnosti počítat z hlavy. 
                S pravidelným cvičením začínají automaticky si vybavovat násobení těchto čísel.
              </p>
            </div>
            ...
            {nextRangeUrl && (
              <div className="bg-white rounded-xl p-6 border-l-4 border-purple-500">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Žáci, kteří dobře zvládnou tento rozsah, jsou připraveni na další. 
                  Každý rozsah dále posiluje logiku násobení a rozvíjí matematické myšlení.
                </p>
              </div>
            )}
          </div>
      ...
      <section className="section-container bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            Vzory v násobilce od {rangeStart} do {rangeEnd}
          </h2>
          
          <p className="text-lg text-slate-700 mb-8 leading-relaxed">
            Místo memorování násobilky, pochopení vzorů v ní obsažených zrychluje 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
              <h3 className="text-lg font-semibold text-slate-900 mb-3 flex items-center">
                ...
                Symetrie (Komutativní zákon)
              </h3>
              <p className="text-slate-700 mb-3">
                Při násobení lze změnit pořadí: {rangeStart} × {rangeEnd} = {rangeEnd} × {rangeStart}. 
            ...
            <div className="bg-green-50 rounded-xl p-6 border border-green-200">
              ...
              <p className="text-slate-700 mb-3">
                ...
                Násobení je opakované sčítání stejného čísla.
              </p>
              <p className="text-sm text-slate-600 italic">
                Tato logika je důležitá pro pochopení základního významu násobení.
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
              ...
              <p className="text-slate-700 mb-3">
                {rangeNumbers.filter(n => n % 2 === 0).length > 0 ? 
                  `Sudá čísla v tomto rozsahu (${rangeNumbers.filter(n => n % 2 === 0).join(', ')}) vždy dávají sudé výsledky.` :
                  'Násobilky čísel v tomto rozsahu vykazují specifické vzory.'
                }
              </p>
              <p className="text-sm text-slate-600 italic">
            ...
            <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
              <h3 className="text-lg font-semibold text-slate-900 mb-3 flex items-center">
                <span className="text-2xl mr-2">🔢</span>
                Vzory poslední číslice
              </h3>
              <p className="text-slate-700 mb-3">
                V násobilce každého čísla se poslední číslice opakují v určitém pořadí. 
      ...
      <section className="section-container bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            Jak se naučit násobilku od {rangeStart} do {rangeEnd}?
          </h2>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-slate-700 mb-4 leading-relaxed">
                Místo toho, abyste se snažili naučit všechna čísla tohoto rozsahu najednou, soustřeďte se každý den na 1-2 čísla. 
                Poté, co jste se naučili jedno číslo dobře, přejděte k dalšímu.
              </p>
              <div className="bg-white rounded-lg p-4 border-l-4 border-blue-600">
                <p className="text-slate-700">
                  <strong>Doporučení:</strong> Poté, co procvičíte každé číslo 3-4 dny po sobě, 
                  začněte se smíšenými úlohami.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-slate-700 mb-4 leading-relaxed">
                Pravidelné cvičení zajišťuje, že naučené informace jsou trvalé:
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-5 border border-gray-200">
                  <p className="font-semibold text-slate-900 mb-2">Rychlé otázky a odpovědi</p>
                  <p className="text-slate-700 text-sm">
                    Denně řešte alespoň 10 náhodných úloh a měřte svůj čas.
                  </p>
                </div>
                <div className="bg-white rounded-lg p-5 border border-gray-200">
      ...
      <section className="section-container bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-center">
            {nextRangeUrl ? 'Pokračujte ve své cestě za vzděláním' : 'Gratulujeme!'}
          </h2>
          
          {nextRangeUrl ? (
            <>
              <p className="text-xl mb-8 leading-relaxed opacity-95 text-center">
                Pokud již bezpečně ovládáte násobilku od {rangeStart} do {rangeEnd}, 
            ...
            <p className="text-xl leading-relaxed opacity-95 text-center">
              Dokončili jste všechny násobilky! Nyní znáte všechna násobení od 1 do 100.
            </p>
          )}
          
          <p className="mt-6 text-sm opacity-80 text-center">
            Buďte trpěliví a konzistentní při učení všech násobi lek. Každý rozsah staví na předchozím.
          </p>
        </div>
      </section>
