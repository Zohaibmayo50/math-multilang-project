    ...
    <section id="learning-paths" className="section-container bg-gradient-to-br from-primary-50 via-white to-educational-50">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-slate-900 mb-6 text-center">
          Začněte se učit násobilku teď
        </h2>
        
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Kompletní vzdělávací cesta násobilky rozdělená do 10 úrovní. 
          Každá úroveň obsahuje podrobná vysvětlení, vzory a strategie učení.
        </p>
        
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          <Link href="/cs/nasobilka/1-10" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Základní tabulky. Výchozí bod pro všechny studenty.
              </p>
          ...
          <Link href="/cs/nasobilka/11-20" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Rozvíjejte dovednosti s dvojcifernými čísly.
              </p>
          ...
          <Link href="/cs/nasobilka/21-30" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Střední úroveň a násobící vzory.
              </p>
          ...
          <Link href="/cs/nasobilka/31-40" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Pokročilé dovednosti počítání zpaměti.
              </p>
          ...
          <Link href="/cs/nasobilka/41-50" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Polovina cesty! Zvládněte až 50.
              </p>
          ...
          <Link href="/cs/nasobilka/51-60" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Pokročilá úroveň. Práce s většími čísly.
              </p>
          ...
          <Link href="/cs/nasobilka/61-70" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Rozvíjejte pokročilé strategie násobení.
              </p>
          ...
          <Link href="/cs/nasobilka/71-80" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/cs/nasobilka/81-90" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/cs/nasobilka/91-100" className="link-card group">
            <div className="flex flex-col h-full">
              ...
              <p className="text-slate-700 text-sm mb-3 flex-grow">
                Závěrečná úroveň! Dokončete 100 a staňte se expertem.
              </p>
        ...
        <div className="mt-10 bg-white border-2 border-primary-200 rounded-lg p-6 text-center">
          <p className="text-slate-700 text-lg">
            <strong className="text-slate-900">Doporučená cesta:</strong> Začněte úrovní 1 (1-10) 
            a poté postupně dokončete všechny úrovně. Přejděte na další úroveň poté, co se budete 
            cítit sebejistě na každé úrovni. Když dosáhnete 100, jste expert na násobilku!
          </p>
        </div>
      </div>
    </section>
