      ...
      <div className="section-container relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-sm border border-blue-100 mb-6">
            ...
            <span className="text-sm font-medium text-blue-700">Od 1 do 100 - Vzrušující učení</span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
            ...
            <br />
            <span className="text-slate-800">Učit se, Rozumět a Cvičit</span>
          </h1>

          {/* Subtitle */}
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Násobilka je jedním z nejdůležitějších základů matematiky. 
            Na této platformě se nejen <span className="font-semibold text-blue-600">naučíte násobilku nazpaměť</span>, 
            ale také ji <span className="font-semibold text-indigo-600">plně pochopíte</span> 
            a pravidelným cvičením ji ovládnete trvale.
          </p>
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-blue-100/50">
              ...
              <div className="text-sm text-slate-600">Tabulky</div>
            </div>
