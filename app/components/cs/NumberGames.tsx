      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-700">
            Procvičujte násobilku {number} zábavnými animovanými hrami!
          </p>
        </div>
            ...
            {!bpGameActive ? (
              <div className="flex flex-col items-center justify-center h-[350px] sm:h-[500px]">
                ...
                <p className="text-sm sm:text-base text-slate-700 mb-4 sm:mb-6 text-center max-w-md px-4">
                  Praskejte balonky se správnými odpověďmi! Nedotýkejte se špatných balonků a nenechte správné uniknout!
                </p>
                <button
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            ...
            {!raceGameActive || raceCar.position >= 90 ? (
              <div className="text-center py-8 sm:py-12">
                ...
                {raceCar.position >= 90 ? (
                  <>
                    <h3 className="text-2xl sm:text-3xl font-bold text-green-600 mb-3 sm:mb-4 px-4">🎉 Gratulujeme! Vyhráli jste!</h3>
                ...
                >
                  {raceCar.position >= 90 ? 'Hrát Znovu' : 'Začít Závod'} 🏎️
                </button>
              </div>
            ) : (
              <div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            ...
            {cards.length === 0 ? (
              <div className="text-center py-8 sm:py-12">
                ...
                <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 px-4">Spárujte násobení s jejich výsledky!</p>
                <button
              ...
              <div>
                <div className="flex justify-center gap-4 sm:gap-6 mb-4 sm:mb-6">
                  ...
                  <div className="text-base sm:text-lg font-semibold">
                    Tahů: <span className="text-purple-600">{memoryMoves}</span>
                  </div>
                </div>
                ...
                {memoryScore === 6 && (
                  <div className="text-center mt-6 sm:mt-8">
                    <h3 className="text-2xl sm:text-3xl font-bold text-green-600 mb-3 sm:mb-4">🎉 Gratulujeme!</h3>
                    <p className="text-lg sm:text-xl mb-3 sm:mb-4">
                      Dokončili jste za {memoryMoves} tahů!
                    </p>
                    <button
                      onClick={initMemoryGame}
