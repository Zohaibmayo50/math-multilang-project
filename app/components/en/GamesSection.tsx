...
export default function GamesSectionEn({ rangeStart = 1, rangeEnd = 10 }: GamesSectionProps) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!activeGame && (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div onClick={() => { setActiveGame('speed'); startSpeedGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Speed Challenge</h3>
              <p className="text-slate-600 mb-4">How many questions can you solve in 60 seconds?</p>
            ...
            <div onClick={() => { setActiveGame('hero'); startHeroGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Multiplication Hero</h3>
              <p className="text-slate-600 mb-4">Complete levels and reach mastery</p>
            ...
            <div onClick={() => { setActiveGame('memory'); startMemoryGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Memory Game</h3>
              <p className="text-slate-600 mb-4">Match the cards and multiply</p>
            ...
            <div onClick={() => { setActiveGame('space'); startSpaceGame(); }} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all cursor-pointer border border-gray-200 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Space Adventure</h3>
              <p className="text-slate-600 mb-4">Launch your rocket with correct answers</p>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-blue-600">🎯 Speed Challenge</h3>
              ...
              {speedActive ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Game Over!</h4>
                  <p className="text-xl text-slate-600 mb-6">Total score: <span className="font-bold text-green-600">{speedScore}</span></p>
        ...
        {activeGame === 'hero' && heroLives > 0 && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-purple-600">🏆 Multiplication Hero</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-red-50 rounded-lg p-4 text-center">
                  <div className="text-sm text-slate-600 mb-1">Lives</div>
        ...
        {activeGame === 'memory' && (
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-pink-600">🎮 Memory Game</h3>
              ...
              {memoryMatches === 6 ? (
                <div className="text-center py-12">
                  <div className="text-6xl mb-4">🎉</div>
                  <h4 className="text-2xl font-bold text-slate-900 mb-2">Congratulations!</h4>
                  <p className="text-xl text-slate-600 mb-6">You matched all the cards!</p>
        ...
        {activeGame === 'space' && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-indigo-600">🚀 Space Adventure</h3>
                <button onClick={() => setActiveGame(null)} className="text-slate-500 hover:text-slate-700">✕</button>
              </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-slate-700">
                Each game uses a different learning technique. Speed Challenge increases your speed, 
                Multiplication Hero helps you overcome difficulty levels, Memory Game develops 
                visual learning, and Space Adventure boosts your motivation.
              </p>
            </div>
          </div>
        </div>
