...
export default function PracticePreviewEn({ rangeStart = 1, rangeEnd = 10 }: PracticePreviewProps) {
  ...
  const exercises = [
    {
      level: 'Easy',
      range: rangeStart === rangeEnd ? `Table ${rangeStart}` : `Tables ${rangeStart}-${Math.min(rangeStart + 4, rangeEnd)}`,
      questions: '20 Questions',
      color: 'bg-green-100 text-green-700 border-green-300'
    },
    {
      level: 'Medium',
      range: rangeStart === rangeEnd ? `Table ${rangeStart}` : `Tables ${rangeStart}-${Math.min(rangeStart + 7, rangeEnd)}`,
      questions: '30 Questions',
      color: 'bg-yellow-100 text-yellow-700 border-yellow-300'
    },
    {
      level: 'Hard',
      range: rangeStart === rangeEnd ? `Table ${rangeStart}` : `Tables ${Math.max(rangeStart, rangeEnd - 5)}-${rangeEnd}`,
      questions: '40 Questions',
      color: 'bg-orange-100 text-orange-700 border-orange-300'
    },
    {
      level: 'Expert',
      range: rangeStart === rangeEnd ? `Table ${rangeStart}` : `Tables ${rangeStart}-${rangeEnd}`,
    ...
    <section id="practice" className="section-container bg-gradient-to-br from-slate-50 to-blue-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-slate-900 mb-4 text-center">
          Practice the {rangeStart} to {rangeEnd} Times Tables
        </h2>
        
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Test your skills with instant feedback
        </p>
                    ...
                    {feedback === 'correct' ? (
                      ...
                      <div>
                        ...
                        <div className="text-base text-slate-600">
                          Correct answer: {question.num1 * question.num2}
                        </div>
                      </div>
                    )}
                  </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-blue-600">📝 Exercises</h3>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-medium text-slate-600">
                    Score: {exerciseQuestions.filter(q => q.correct === true).length}
                  </span>
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-12 mb-6">
                ...
                <div className="flex gap-4 items-center justify-center">
                  ...
                  >
                    {currentQuestionIndex < exerciseQuestions.length - 1 ? 'Next' : 'Finish'}
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
              <div className="text-center py-8">
                ...
                <h3 className="text-3xl font-bold text-slate-900 mb-4">Exercise Complete!</h3>
                ...
                {exerciseQuestions.filter(q => q.correct === false).length > 0 && (
                  <div className="mt-8 text-left max-w-xl mx-auto">
                    <h4 className="font-semibold text-slate-900 mb-4">Incorrect Answers:</h4>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-slate-700">
                Practice isn't just about speed. Think carefully about each question, 
                analyze your incorrect answers, and identify which multiplication tables 
                are causing difficulties. Regular practice of 10-15 minutes 
                daily is the most effective method for long-term learning.
              </p>
            </div>
          </div>
        </div>
