...
export default function PrintableExercisesEn({ rangeStart: defaultRangeStart = 1, rangeEnd: defaultRangeEnd = 10 }: PrintableExercisesProps) {
  ...
  const handlePrint = () => {
    ...
    if (printWindow) {
      const title = exerciseType === 'single' 
        ? `${selectedTable} Times Table Exercises`
        : exerciseType === 'mixed'
        ? 'Mixed Multiplication Exercises'
        : `${rangeStart}-${rangeEnd} Times Tables Exercises`
    ...
    <section id="pdf-exercises" className="section-container bg-gradient-to-br from-purple-50 to-pink-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-slate-700 max-w-3xl mx-auto mb-12 text-lg">
          Create customized multiplication table exercises for your students or children. 
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                    ...
                    />
                    <div>
                      <div className="font-medium text-slate-900">Single Times Table</div>
                      <div className="text-sm text-slate-600">One specific times table</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                    ...
                    />
                    <div>
                      <div className="font-medium text-slate-900">Range</div>
                      <div className="text-sm text-slate-600">Times tables within a range</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                    ...
                    />
                    <div>
                      <div className="font-medium text-slate-900">Mixed</div>
                      <div className="text-sm text-slate-600">Random from all times tables</div>
                    </div>
                  </label>
                </div>
              </div>
              ...
              <div>
                <label className="flex items-center p-4 bg-amber-50 border-2 border-amber-200 rounded-lg cursor-pointer">
                  ...
                  />
                  <div>
                    <div className="font-medium text-slate-900">Include Answer Key</div>
                    <div className="text-sm text-slate-600">Adds answers at the end of the page</div>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200">
              ...
              <div className="bg-white rounded-lg p-4 mb-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Answer Key:</span>
              ...
              <div className="bg-white rounded-lg p-4 space-y-2">
                <div className="text-sm font-semibold text-slate-700 mb-2">Sample Questions:</div>
                {[...Array(3)].map((_, i) => {
              ...
              <div className="mt-4 p-3 bg-blue-100 rounded-lg border border-blue-300">
                <p className="text-sm text-blue-900">
                  💡 <strong>Tip:</strong> You can save as PDF using your browser's print function.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
            ...
            <p className="text-sm text-slate-600">
              Customize the number of questions, times tables, and difficulty level to suit your needs.
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
            <div className="text-3xl mb-3">📱</div>
            <h4 className="font-bold text-slate-900 mb-2">Mobile-friendly</h4>
            <p className="text-sm text-slate-600">
              Print easily from phone, tablet, or computer.
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
            <div className="text-3xl mb-3">💾</div>
            <h4 className="font-bold text-slate-900 mb-2">Save and Share</h4>
            <p className="text-sm text-slate-600">
              Save as PDF and easily share with your students.
            </p>
          </div>
        </div>
      </div>
