      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-slate-200">
          <div className="px-4 py-4 space-y-3">
            {/* Tables Section */}
            <div>
              <div className="font-semibold text-slate-900 mb-2">Multiplication Tables</div>
              <div className="space-y-1 pl-4">
                <Link href="/en/multiplication-tables/1-10" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  1-10 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/11-20" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  11-20 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/21-30" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  21-30 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/31-40" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  31-40 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/41-50" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  41-50 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/51-60" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  51-60 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/61-70" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  61-70 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/71-80" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  71-80 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/81-90" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  81-90 Times Tables
                </Link>
                <Link href="/en/multiplication-tables/91-100" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  91-100 Times Tables
                </Link>
              </div>
            </div>
            ...
            {/* Guides Section */}
            <div>
              <div className="font-semibold text-slate-900 mb-2">Guides</div>
              <div className="space-y-1 pl-4">
                <Link href="/en/multiplication-tables/for-students" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  👨‍🎓 For Students
                </Link>
                <Link href="/en/multiplication-tables/for-parents" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  👪 For Parents
                </Link>
                <Link href="/en/multiplication-tables/for-teachers" onClick={closeMobileMenu} className="block py-2 text-sm text-slate-600 hover:text-blue-600">
                  👩‍🏫 For Teachers
                </Link>
              </div>
            </div>
