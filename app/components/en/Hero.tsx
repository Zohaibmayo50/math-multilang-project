      ...
      <div className="section-container relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-sm border border-blue-100 mb-6">
            ...
            <span className="text-sm font-medium text-blue-700">Fun Learning from 1 to 100</span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
            ...
            <br />
            <span className="text-slate-800">Learn, Understand, and Practice</span>
          </h1>

          {/* Subtitle */}
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Multiplication tables are one of the fundamental pillars of mathematics. 
            On this platform, you won't just <span className="font-semibold text-blue-600">memorize the multiplication tables</span>, 
            but you'll also learn them permanently by <span className="font-semibold text-indigo-600">understanding the logic</span> and 
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-blue-100/50">
              ...
              <div className="text-sm text-slate-600">Times Tables</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-indigo-100/50">
              ...
              <div className="text-sm text-slate-600">Level Ranges</div>
            </div>
