    ...
    <section id="definition" className="section-container bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-slate-700">
          ...
          <p>
            Por exemplo, a expressão 3 × 4 = 12 faz parte da tabuada. 
            Esta expressão significa "o número 3 somado 4 vezes" ou "o número 4 somado 3 vezes". 
            A tabuada permite que realizemos tais operações 
