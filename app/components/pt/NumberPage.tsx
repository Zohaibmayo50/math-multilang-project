...
export default function NumberPagePt({ number, rangeStart, rangeEnd }: NumberPageProps) {
  return <UniversalNumberPage lang="pt" number={number} rangeStart={rangeStart} rangeEnd={rangeEnd} />
}
