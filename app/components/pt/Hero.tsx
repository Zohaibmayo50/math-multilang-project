      ...
      <div className="section-container relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-sm border border-blue-100 mb-6">
            ...
            <span className="text-sm font-medium text-blue-700">Aprendizado Divertido de 1 a 100</span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
            ...
            <br />
            <span className="text-slate-800">Aprenda, Entenda e Pratique</span>
          </h1>

          {/* Subtitle */}
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-8">
            A tabuada é um dos pilares fundamentais da matemática. 
            Nesta plataforma, você não vai apenas <span className="font-semibold text-blue-600">memorizar a tabuada</span>, 
            mas também aprendê-la permanentemente ao <span className="font-semibold text-indigo-600">compreender a lógica</span> e 
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-blue-100/50">
              ...
              <div className="text-sm text-slate-600">Tabuadas</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-indigo-100/50">
              ...
              <div className="text-sm text-slate-600">Faixas de Nível</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-purple-100/50">
              <div className="text-3xl font-bold text-purple-600 mb-1">∞</div>
              <div className="text-sm text-slate-600">Exercícios</div>
            </div>
          </div>
        </div>
      </div>
