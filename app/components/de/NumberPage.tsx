...
export default function NumberPageDe({ number, rangeStart, rangeEnd }: NumberPageProps) {
  return <UniversalNumberPage lang="de" number={number} rangeStart={rangeStart} rangeEnd={rangeEnd} />
}
