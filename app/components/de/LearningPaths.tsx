    ...
    <section id="learning-paths" className="section-container bg-gradient-to-br from-primary-50 via-white to-educational-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          <Link href="/de/einmaleins/1-10" className="link-card group">
          ...
          <Link href="/de/einmaleins/11-20" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/21-30" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/31-40" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/41-50" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/51-60" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/61-70" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/71-80" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/81-90" className="link-card group">
            <div className="flex flex-col h-full">
          ...
          <Link href="/de/einmaleins/91-100" className="link-card group">
            <div className="flex flex-col h-full">
