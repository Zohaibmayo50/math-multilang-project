...
const hubContent: Record<Locale, {
  ...
  de: {
    introTitle: 'Willkommen bei Mathematives — Deine kostenlose Einmaleins-Lernplattform',
    introText: 'Mathematives bietet dir eine völlig kostenlose Möglichkeit, das Einmaleins von 1 bis 100 auf Deutsch zu lernen. Jede Tabelle enthält eine übersichtliche Darstellung, leicht verständliche Strategien, Zahleigenschaften und interaktive Übungsaufgaben. Ob du Schüler bist, als Elternteil Hilfe bei den Hausaufgaben suchst oder als Lehrkraft Unterrichtsmaterialien benötigst — unsere Plattform ist für dich gemacht.',
    whyTitle: 'Warum ist das Einmaleins so wichtig?',
    whyReasons: [
      { icon: '🧠', title: 'Kopfrechnen stärken', text: 'Wer das Einmaleins auswendig kann, tut sich bei Addition, Subtraktion, Division und Bruchrechnung viel leichter. Es ist das Fundament mathematischer Kompetenz.' },
      { icon: '📈', title: 'Schulleistungen verbessern', text: 'Studien zeigen, dass Schüler, die das Einmaleins beherrschen, in allen mathematischen Bereichen besser abschneiden — von Algebra bis Geometrie.' },
      { icon: '⏱️', title: 'Zeit bei Berechnungen sparen', text: 'Sofortiger Abruf von Multiplikationswissen bedeutet weniger Zeit für Grundrechenarten und mehr Zeit für Problemlösung und kritisches Denken.' },
      { icon: '🎯', title: 'Vorbereitung auf höhere Mathematik', text: 'Multiplikation ist grundlegend für das Verständnis von Division, Brüchen, Prozentrechnung und algebraischen Ausdrücken.' },
    ],
    featuresTitle: 'Was macht Mathematives besonders?',
    features: [
      { icon: '📊', title: 'Komplettes Einmaleins 1 bis 100', text: 'Wir behandeln jede Einmaleins-Reihe von 1 bis 100 — nicht nur die Grundlagen von 1 bis 12. Jede Zahl hat eine eigene Seite mit vollständiger Tabelle.' },
      { icon: '🎓', title: 'Experten-Lerntipps', text: 'Jede Seite enthält spezifische Strategien — wie den Fingertrick für die 9er-Reihe, Verdopplungsstrategien für die 4er-Reihe oder Mustererkennung für die 11er-Reihe.' },
      { icon: '🖨️', title: 'Druckbare Materialien', text: 'Übungsblätter und Arbeitsblätter für den Unterricht oder das Lernen zu Hause. Einfach ausdrucken und offline üben.' },
      { icon: '📱', title: 'Funktioniert auf allen Geräten', text: 'Mathematives funktioniert auf Handys, Tablets und Computern. Kein App-Download nötig — einfach den Browser öffnen und loslernen.' },
    ],
    popularTitle: 'Beliebte Einmaleins-Reihen',
    popularDesc: 'Starte mit den am häufigsten gelernten Reihen. Diese sind für ein starkes Mathefundament unverzichtbar.',
    ...
    faqs: [
      { q: 'Ist Mathematives wirklich kostenlos?', a: 'Ja. Alle Inhalte — jede Tabelle von 1 bis 100, alle Lerntipps und Übungen — sind zu 100% kostenlos und ohne Registrierung nutzbar.' },
      { q: 'Für welche Altersgruppe ist es geeignet?', a: 'Mathematives ist für alle Altersgruppen geeignet. Schüler von 6 bis 12 Jahren konzentrieren sich meist auf die Reihen 1 bis 10, ältere Lernende können bis 100 üben.' },
      { q: 'Wie sollte ich anfangen?', a: 'Wir empfehlen, mit den Reihen 1 bis 5 zu beginnen und dann zu 6-10 überzugehen. Sobald diese sitzen, kannst du mit 11-20 und darüber hinaus weitermachen.' },
      { q: 'Können Lehrer das im Unterricht nutzen?', a: 'Selbstverständlich. Lehrkräfte sind herzlich eingeladen, Mathematives als ergänzendes Unterrichtsmaterial zu verwenden. Keine Konten nötig, druckbare Materialien inklusive.' },
    ],
    footerText: 'Kostenloses Einmaleins-Training — lerne in deinem eigenen Tempo.',
  },
  cs: {
  ...
  fr: {
    introTitle: 'Bienvenue sur Mathematives — Votre plateforme gratuite pour apprendre les tables',
    introText: 'Mathematives vous offre un moyen entièrement gratuit d\'apprendre les tables de multiplication de 1 à 100 en français. Chaque table comprend un tableau clair, des stratégies faciles à suivre, les propriétés des nombres et des exercices interactifs. Que vous soyez élève, parent cherchant de l\'aide pour les devoirs ou enseignant à la recherche de ressources pédagogiques — notre plateforme est conçue pour vous.',
    whyTitle: 'Pourquoi les tables de multiplication sont-elles importantes ?',
    whyReasons: [
      { icon: '🧠', title: 'Développer le calcul mental', text: 'Connaître ses tables par cœur facilite considérablement l\'addition, la soustraction, la division et les fractions. C\'est le fondement de l\'aisance mathématique.' },
      { icon: '📈', title: 'Améliorer les résultats scolaires', text: 'Les études montrent que les élèves qui maîtrisent leurs tables obtiennent de meilleurs résultats dans tous les domaines des maths, de l\'algèbre à la géométrie.' },
      { icon: '⏱️', title: 'Gagner du temps dans les calculs', text: 'La mémorisation instantanée des multiplications signifie moins de temps sur les calculs de base et plus de temps pour la résolution de problèmes.' },
      { icon: '🎯', title: 'Préparation aux maths avancées', text: 'La multiplication est essentielle pour comprendre la division longue, les fractions, les pourcentages, les proportions et les expressions algébriques.' },
    ],
    featuresTitle: 'Qu\'est-ce qui rend Mathematives différent ?',
    features: [
      { icon: '📊', title: 'Tables complètes de 1 à 100', text: 'Nous couvrons chaque table de multiplication de 1 à 100 — pas seulement les tables de base de 1 à 12. Chaque nombre a sa propre page dédiée.' },
      { icon: '🎓', title: 'Conseils d\'apprentissage experts', text: 'Chaque page propose des stratégies spécifiques — comme l\'astuce des doigts pour la table de 9, le doublement pour la table de 4 ou la reconnaissance de motifs.' },
      { icon: '🖨️', title: 'Ressources imprimables', text: 'Exercices et fiches de travail conçus pour l\'utilisation en classe ou à la maison. Imprimez et travaillez hors ligne quand vous le souhaitez.' },
      { icon: '📱', title: 'Fonctionne sur tous les appareils', text: 'Mathematives fonctionne parfaitement sur téléphones, tablettes et ordinateurs. Aucun téléchargement nécessaire.' },
    ],
    popularTitle: 'Tables de multiplication populaires',
    popularDesc: 'Commencez par les tables les plus étudiées. Elles sont essentielles pour construire des bases solides en maths.',
    ...
    faqs: [
      { q: 'Mathematives est-il vraiment gratuit ?', a: 'Oui. Tout le contenu — chaque table de 1 à 100, tous les conseils et exercices — est 100% gratuit sans inscription.' },
      { q: 'Pour quel âge est-ce adapté ?', a: 'Mathematives convient à tous les âges. Les élèves de 6 à 12 ans se concentrent généralement sur les tables de 1 à 10, les plus grands peuvent explorer jusqu\'à 100.' },
      { q: 'Comment dois-je commencer ?', a: 'Nous recommandons de commencer par les tables de 1 à 5, puis de passer à 6-10. Une fois mémorisées, continuez avec les groupes 11-20 et au-delà à votre rythme.' },
      { q: 'Les enseignants peuvent-ils l\'utiliser en classe ?', a: 'Bien sûr. Les enseignants sont les bienvenus pour utiliser Mathematives comme ressource complémentaire. Le contenu est accessible sans compte et inclut des supports imprimables.' },
    ],
    footerText: 'Entraînement gratuit aux tables de multiplication — apprenez à votre rythme.',
  },
  sv: {
    introTitle: 'Välkommen till Mathematives — Din gratis plattform för multiplikationstabeller',
    introText: 'Mathematives erbjuder ett helt gratis sätt att lära sig multiplikationstabellerna från 1 till 100 på svenska. Varje tabell innehåller ett tydligt diagram, lättföljda strategier, talegenskaper och interaktiva övningar. Oavsett om du är elev, förälder som söker läxhjälp eller lärare som behöver klassrumsmaterial — vår plattform är byggd för dig.',
    whyTitle: 'Varför är multiplikationstabellerna viktiga?',
    whyReasons: [
      { icon: '🧠', title: 'Stärk huvudräkningsförmågan', text: 'Att kunna tabellerna utantill gör addition, subtraktion, division och bråkräkning betydligt enklare. Det är grunden för matematisk färdighet.' },
      { icon: '📈', title: 'Förbättra skolprestationer', text: 'Studier visar att elever som memorerar sina multiplikationstabeller presterar bättre i alla matematikområden, från algebra till geometri.' },
      { icon: '⏱️', title: 'Spara tid på beräkningar', text: 'Omedelbar minnesåterkallelse av multiplikationsfakta innebär mindre tid på grundläggande beräkningar och mer tid för problemlösning.' },
      { icon: '🎯', title: 'Förberedelse för avancerad matematik', text: 'Multiplikation är avgörande för att förstå division, bråk, procent, proportioner och algebraiska uttryck.' },
    ],
    featuresTitle: 'Vad gör Mathematives speciellt?',
    features: [
      { icon: '📊', title: 'Fullständiga tabeller 1 till 100', text: 'Vi täcker varje multiplikationstabell från 1 till 100 — inte bara grunderna 1 till 12. Varje tal har sin egen sida med komplett tabell.' },
      { icon: '🎓', title: 'Expertinlärningstips', text: 'Varje sida innehåller specifika strategier — som fingertricket för 9:ans tabell, fördubblingsstrategier för 4:ans tabell eller mönsterigenkänning.' },
      { icon: '🖨️', title: 'Utskrivbara resurser', text: 'Övningar och arbetsblad utformade för klassrumsbruk eller hemmabruk. Skriv ut och öva offline när du vill.' },
      { icon: '📱', title: 'Fungerar på alla enheter', text: 'Mathematives fungerar på telefoner, surfplattor och datorer. Ingen app behöver laddas ner — öppna din webbläsare och börja lära dig.' },
    ],
    popularTitle: 'Populära multiplikationstabeller',
    popularDesc: 'Börja med de mest studerade tabellerna. Dessa är avgörande för att bygga en stark matematisk grund.',
    ...
    faqs: [
      { q: 'Är Mathematives verkligen gratis?', a: 'Ja. Allt innehåll — varje tabell från 1 till 100, alla tips och övningar — är 100% gratis utan registrering.' },
      { q: 'Vilken åldersgrupp passar det för?', a: 'Mathematives passar alla åldrar. Elever 6–12 år fokuserar vanligtvis på tabellerna 1–10, äldre elever kan utforska upp till 100.' },
      { q: 'Hur ska jag börja?', a: 'Vi rekommenderar att börja med tabellerna 1 till 5, sedan gå vidare till 6–10. När de sitter, fortsätt med grupperna 11–20 och framåt i din egen takt.' },
      { q: 'Kan lärare använda detta i klassrummet?', a: 'Absolut. Lärare är välkomna att använda Mathematives som kompletterande resurs. Innehållet kräver inga konton och inkluderar utskrivbart material.' },
    ],
    footerText: 'Gratis multiplikationstabellsträning — lär dig i din egen takt.',
  },
  pt: {
