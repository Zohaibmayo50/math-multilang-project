...
export const metadata: Metadata = {
  title: 'Multiplication Tables | Çarpım Tablosu | Tablas de Multiplicar',
  description: 'Learn multiplication tables in your language. Choose Turkish, Spanish, or German.',
  alternates: {
    canonical: '/',
  },
  robots: {
