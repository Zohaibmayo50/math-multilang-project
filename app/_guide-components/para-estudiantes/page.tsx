              ...
              <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 border-l-4 border-green-500">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3">
                      <Link href="/es/tablas-de-multiplicar/1-10" className="text-green-600 hover:text-green-700 font-medium inline-flex items-center">
          ...
          <section className="mb-12 md:mb-16">
            ...
            <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
              <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
                ...
                <Link href="/es/tablas-de-multiplicar" className="text-blue-600 hover:text-blue-700 font-medium inline-flex items-center text-sm">
                  Descubre los Juegos →
                </Link>
              </div>
