          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6">
                Learning Times Tables is Really Easy! 🎯
              </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <section className="mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 md:mb-6">
              Why Should I Learn Times Tables? 🤔
            </h2>
            ...
            <div className="space-y-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-green-50 p-4 rounded-lg">
                      ...
                      <ul className="space-y-1 text-slate-700 text-sm">
                        <li>• <strong>1 Times Table:</strong> Every number stays the same! (1×5=5)</li>
                        <li>• <strong>2 Times Table:</strong> Add the number twice! (2×4 = 4+4 = 8)</li>
                        <li>• <strong>5 Times Table:</strong> Always ends in 5 or 0!</li>
                        <li>• <strong>10 Times Table:</strong> Add a zero at the end! (10×3 = 30)</li>
                      </ul>
                    </div>
                    <div className="mt-3">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <ul className="space-y-1 text-slate-700 text-sm">
                        <li>• <strong>3 Times Table:</strong> Add the number 3 times (3×4 = 4+4+4 = 12)</li>
                        <li>• <strong>4 Times Table:</strong> Multiply by 2, then double it (4×5 = 2×5×2 = 20)</li>
                        <li>• <strong>6 Times Table:</strong> Use the 5 times table and add 1 more (6×4 = 5×4 + 4 = 24)</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      ...
                      <ul className="space-y-2 text-slate-700 text-sm">
                        <li>• <strong>9 Times Table - Finger Trick:</strong> Hold up both hands, lower the finger of the number you're multiplying. Fingers up on the left = tens, fingers on the right = ones!</li>
                        <li>• <strong>8 Times Table:</strong> Multiply by 10, then subtract 2 times (8×7 = 10×7 - 2×7 = 70-14 = 56)</li>
                        <li>• <strong>7 Times Table:</strong> For the tricky ones use the 5 times table (7×6 = 5×6 + 2×6 = 30+12 = 42)</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-slate-900 mb-2">Practice Constantly 💪</h3>
                    <p className="text-slate-700 mb-3">
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg">
                      ...
                      <ul className="space-y-1 text-slate-700 text-sm">
                        <li>• Study 10-15 minutes each day (not much, but regular!)</li>
                        <li>• Practice by playing - it's fun!</li>
                        <li>• Organize competitions with your family</li>
                        <li>• When you see multiplication in daily life, calculate it (e.g., "3 boxes, 5 chocolates in each, how many total?")</li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <section className="mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 md:mb-6">
              Visual Learning - Understand with Pictures 🎨
            </h2>
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8">
              <p className="text-base sm:text-lg text-slate-700 mb-4 md:mb-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg">
                  ...
                  <p className="text-slate-700 mb-4 text-sm">Example of 4 × 3 = 12:</p>
                  <div className="bg-white p-4 rounded inline-block">
                    ...
                    <p className="text-center mt-2 text-sm text-slate-600">4 columns × 3 rows = 12</p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg">
                  ...
                  <p className="text-slate-700 mb-4 text-sm">3 × 4: jumps of 4 (0→4→8→12)</p>
            ...
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8">
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border-l-4 border-green-500">
                  <h3 className="text-lg font-semibold text-green-900 mb-2">✅ Times Tables Checklist</h3>
                  <p className="text-slate-700 text-sm">
                    Write times tables 1-10 on paper. Each time you learn one, put a big check! 
                    When all checks are complete, you're a times tables hero! 🌟
                  </p>
                </div>

                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-6 rounded-lg border-l-4 border-blue-500">
                  <h3 className="text-lg font-semibold text-blue-900 mb-2">📈 Progress Chart</h3>
                  <p className="text-slate-700 text-sm">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-lg border-l-4 border-purple-500">
                  <h3 className="text-lg font-semibold text-purple-900 mb-2">⭐ Star System</h3>
                  <p className="text-slate-700 text-sm">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8">
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-slate-700">Everything is zero! 0×1000=0</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-bold text-green-900 mb-2">Multiply by 1</h4>
                  <p className="text-sm text-slate-700">The number stays the same! 1×7=7</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-bold text-purple-900 mb-2">Multiply by 2</h4>
                  <p className="text-sm text-slate-700">Double the number! 2×6=12</p>
                </div>
                ...
                <div className="bg-indigo-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-slate-700">Add a 0! 10×8=80</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg shadow-lg p-6 sm:p-8 text-white text-center">
            ...
            <div className="mt-8 pt-8 border-t border-blue-400">
              <p className="text-blue-100 text-sm">
                💡 <strong>Tip:</strong> Studying 10-15 minutes per day is much more effective than studying 1 boring hour!
              </p>
            </div>
          </section>
        </div>
